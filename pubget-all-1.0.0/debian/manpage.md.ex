% pubget-all(SECTION) | User Commands
%
% "October 18 2024"
...
pubget-all - program to do something

# SYNOPSIS

**pubget-all** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pubget-all** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pubget-all** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pubget-all** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pubget-all. See **foo.conf**(5) for further details.
...
**pubget-all** provides some return codes, that can be used in scripts:
